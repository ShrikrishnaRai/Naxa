package naxa.naxaco.com.naxa.MapsActivity.Fragment;
...
public class MapFragment extends Fragment {
    FloatingActionMenu vFloatingActionMenu;
    FloatingActionButton vFloatingActionButtonKML;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        vFloatingActionButtonKML = view.findViewById(R.id.menu_item);
        vFloatingActionButtonGeoJSON = view.findViewById(R.id.menu_item1);
        vFloatingActionMenu = view.findViewById(R.id.menu);
        vFloatingActionMenu.setVisibility(View.GONE);
        vFloatingActionButtonKML.setVisibility(View.GONE);
        vFloatingActionButtonGeoJSON.setVisibility(View.GONE);
        return view;
    }
}*/
...
public class MapModalFragment extends Fragment implements OnMapReadyCallback, GoogleMap.OnMapClickListener, GoogleMap.OnMapLongClickListener, GoogleMap.OnMarkerClickListener {
    ...
    FloatingActionButton vFloatingActionButtonKML;
    FloatingActionButton vFloatingActionButtonGeoJSON;
    FloatingActionButton vFloatingActionButtonSave;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        vFloatingActionButtonKML = view.findViewById(R.id.menu_item);
        vFloatingActionButtonGeoJSON = view.findViewById(R.id.menu_item1);
        vFloatingActionButtonSave=view.findViewById(R.id.menu_item2);
        vFloatingActionButtonSave.setVisibility(View.GONE);
        vFloatingActionMenu = view.findViewById(R.id.menu);
        vFloatingActionMenu.setVisibility(View.GONE);
        vFloatingActionButtonKML.setVisibility(View.GONE);
        vFloatingActionButtonGeoJSON.setVisibility(View.GONE);
